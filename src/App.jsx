      ...
      <div className="persian bg-gray-50">
        ...
        <Container>
          <div>
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1 grid">
                <CourseTile
                  imgSrc={courseSvg}
                  title={"زبان انگلیسی"}
                ...
                <CourseTile
                  imgSrc={courseSvg}
                  title={"داستان‌نویسی"}
                  learning={"تقویت خلاقیت، احساس درونی، جهان داستانی"}
                  description={
                    "ساختن و خلق کردن با کلمات و رسیدن به قصه، تخیل هنرجو را در زمینه‌های مختلف زندگی شخصی‌‌اش گسترش می‌دهد و این موضوع در دقت و هوشیاری، خلاقیت، ارتباطات اجتماعی و افزایش اعتماد‌به‌نفس دانش‌آموزان مؤثر خواهد بود. ما در این دوره‌ی آموزشی در نظر داریم با تأکید بر اهمیت احساسات درونی و به‌کارگیری آن‌ها در نویسندگی، قصه‌گویی را تمرین کنیم و جهانی داستانی را برای دانش‌آموزان به وجود بیاوریم."
                  }
                  teachers={[shirinSvg]}
                />
                ...
                <CourseTile
                  ...
                  description={
                    "در کارگاه شاهنامه‌خوانی به سفری ماجراجویانه می‌رویم؛ سفری به سپیده‌دم تاریخ. با هم به تماشای داستان‌هایی که گرمابخش شب‌‌نشینی‌های نیاکان‌مان بوده می‌نشینیم و می‌بینیم که درباره‌ی گذشته‌های دور چطور فکر می‌کردند و جهان را چگونه می‌دیدند. چراغ راه این سفر شاهنامه‌ی فردوسی است و ما دور آتش گرم و جاودانش داستان‌های باستانی ایرانی را کنار هم می‌خوانیم؛ با شخصیت‌های شاهنامه آشنا می‌شویم و با فعالیت‌های گوناگون در داستان‌ها و موقعیت‌ شخصیت‌ها کنکاش می‌کنیم."
                  }
                  teachers={[matinSvg]}
                />
        ...
        <Container>
          <div className="bg-[#DBEFF2] rounded-2xl flex p-4 flex-col md:flex-row">
            <div>
              ...
              <p className="text-red-700 text-lg mb-12 p-4">
                مهلت ثبت نام تا آخر آبان ماه است.
              </p>
              <div className="w-fit">
                <Button
